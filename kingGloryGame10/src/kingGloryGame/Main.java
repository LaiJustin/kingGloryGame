	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() ->
        {
        	...
        	ZhanChangZhanShi.zhanShiDiTu();
        	 /* 
           ShapeOfRoleAndSkill ShapeOfRoleAndSkill =ZhanChangZhanShi.ShapeOfRoleAndSkill;
           RenWuChuShiHua RenWuChuShiHua  = new RenWuChuShiHua();
           ...
           Role hero5 = new Alien("player5",new HuoQiu(),new XuanFeng(),new BuDiaoXue());
           Role hero6 = new Alien("player6",new HuoQiu(),new XuanFeng(),new BuDiaoXue());
           Role hero7 = new Alien("player7",new DianJi(),new XuanFeng(),new BuDiaoXue());
           Role hero8 = new Alien("player8",new ZhiLiao(),new XuanFeng(),new BuDiaoXue());
           RenWuChuShiHua.SetRole(hero1, 1, ShapeOfRoleAndSkill);
           RenWuChuShiHua.SetRole(hero2, 1, ShapeOfRoleAndSkill);
           RenWuChuShiHua.SetRole(hero3, 1, ShapeOfRoleAndSkill);
           RenWuChuShiHua.SetRole(hero4, 1, ShapeOfRoleAndSkill);
           RenWuChuShiHua.SetRole(hero5, 2, ShapeOfRoleAndSkill);
           RenWuChuShiHua.SetRole(hero6, 2, ShapeOfRoleAndSkill);
           RenWuChuShiHua.SetRole(hero7, 2, ShapeOfRoleAndSkill);
           RenWuChuShiHua.SetRole(hero8, 2, ShapeOfRoleAndSkill);*/
        });
	}
}
